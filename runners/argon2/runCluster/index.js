...
const hashArgon2CCluster = require('./hashArgon2CCluster');
const hashArgon2JSCluster = require('./hashArgon2JSCluster');
...
const childProcess = () => {
  process.on('message', (message) => {
    (async () => {
      await hashArgon2JSCluster(message.processNumber);
