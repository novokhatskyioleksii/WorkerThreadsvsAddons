...
console.log(`(murmurhash) C++ Total: ${((totalC - checkTime) / 1000).toFixed(2)} milliseconds`);
console.log(`(murmurhash) JS Total: ${((totalJS - checkTime) / 1000).toFixed(2)} milliseconds`);

console.log(`(murmurhash) C++: ${meanC.toFixed(2)} +- ${SDC.toFixed(2)} microseconds`);
console.log(`(murmurhash) JS: ${meanJS.toFixed(2)} +- ${SDJS.toFixed(2)} microseconds`);
